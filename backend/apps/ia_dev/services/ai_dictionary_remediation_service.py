...
class AIDictionaryRemediationService:
    ...
    def _curated_fields(self, *, domain_code: str) -> list[dict[str, Any]]:
        ...
        return [
            ...
            self._field("bd_c3nc4s1s", "cinco_base_de_personal", "supervisor", "supervisor", capabilities={"supports_filter": True, "supports_group_by": True, "supports_dimension": True}, definition="Cedula del jefe directo. [semantic_type=supervisor_identifier][must_exist_in=cedula][empty_value=alert][critical_when=tipo_labor_operativo][exception_cargo=gerente][privacy=low]"),
            self._field("bd_c3nc4s1s", "cinco_base_de_personal", "area", "area", capabilities={"supports_filter": True, "supports_group_by": True, "supports_dimension": True}, definition="Agrupador organizacional principal. [semantic_type=org_area][hierarchy_level=2][privacy=low]"),
            ...
            self._field("bd_c3nc4s1s", "cinco_base_de_personal", "movil", "movil", capabilities={"supports_filter": True, "supports_group_by": True, "supports_dimension": True}, definition="Agrupador operativo del empleado. [semantic_type=operational_mobile][hierarchy_level=4][not_unique_per_employee=true][privacy=low]"),
            self._field("bd_c3nc4s1s", "cinco_base_de_personal", "tipo_labor", "tipo_labor", capabilities={"supports_filter": True, "supports_group_by": True, "supports_dimension": True}, definition="Clasificacion laboral oficial. [semantic_type=labor_type][operativo_requires_mobile=true][operativo_requires_supervisor=true][operativo_requires_heights_certificate=true][administrativo_requires_supervisor=true][supervisor_may_sign_heights_permits=true][transversal_field_work=false][privacy=low]", allowed_values="OPERATIVO,ADMINISTRATIVO,SUPERVISOR,TRANSVERSAL"),
            self._field("bd_c3nc4s1s", "cinco_base_de_personal", "zona_nodo", "sede", capabilities={"supports_filter": True, "supports_group_by": True, "supports_dimension": True}, definition="Agrupador geografico principal. [semantic_type=site][hierarchy_level=1][privacy=low]"),
            ...
            self._field("bd_c3nc4s1s", "cinco_base_de_personal", "correo", "correo_corporativo", capabilities={"supports_filter": True}, definition="Correo corporativo oficial. [semantic_type=corporate_email][privacy=low]"),
            ...
            self._field("bd_c3nc4s1s", "cinco_base_de_personal", "celular_personal", "celular_personal", capabilities={"supports_filter": True}, definition="Telefono personal principal. [semantic_type=personal_phone][visibility_condition=supervisor_or_administrativo][privacy=medium]"),
            self._field("bd_c3nc4s1s", "cinco_base_de_personal", "celular_alterno", "celular_alterno", capabilities={"supports_filter": True}, definition="Telefono personal alterno. [semantic_type=personal_phone_secondary][visibility_condition=supervisor_or_administrativo][privacy=medium]"),
            ...
            self._field("bd_c3nc4s1s", "cinco_base_de_personal", "permiso_trabajo", "permiso_trabajo", capabilities={"supports_filter": True}, definition="Documento migratorio o legal para extranjeros. [semantic_type=work_permit][not_hseq=true][privacy=high]"),
            self._field("bd_c3nc4s1s", "cinco_base_de_personal", "arl", "arl", capabilities={"supports_filter": True, "supports_group_by": True, "supports_dimension": True}, definition="Administradora de riesgos laborales. [semantic_type=occupational_risk_provider][privacy=low]"),
            self._field("bd_c3nc4s1s", "cinco_base_de_personal", "eps", "eps", capabilities={"supports_filter": True, "supports_group_by": True, "supports_dimension": True}, definition="Entidad promotora de salud. [semantic_type=health_provider][display_allowed_if_requested=true][privacy=medium]"),
            ...
            self._field("bd_c3nc4s1s", "cinco_base_de_personal", "datos", "talla_botas", capabilities={"supports_filter": True}, definition="Talla de botas del empleado. [json_path=$.tallas.botas][semantic_type=uniform_size][missing_value_alert=incomplete_information][multiple_semantic_views_allowed=true][privacy=low]"),
            self._field("bd_c3nc4s1s", "cinco_base_de_personal", "datos", "talla_camisa", capabilities={"supports_filter": True}, definition="Talla de camisa del empleado. [json_path=$.tallas.camisa][semantic_type=uniform_size][missing_value_alert=incomplete_information][multiple_semantic_views_allowed=true][privacy=low]"),
            self._field("bd_c3nc4s1s", "cinco_base_de_personal", "datos", "talla_chaqueta", capabilities={"supports_filter": True}, definition="Talla de chaqueta del empleado. [json_path=$.tallas.chaqueta][semantic_type=uniform_size][missing_value_alert=incomplete_information][multiple_semantic_views_allowed=true][privacy=low]"),
            self._field("bd_c3nc4s1s", "cinco_base_de_personal", "datos", "talla_guerrera", capabilities={"supports_filter": True}, definition="Talla de guerrera del empleado. [json_path=$.tallas.guerrera][semantic_type=uniform_size][missing_value_alert=incomplete_information][multiple_semantic_views_allowed=true][privacy=low]"),
            self._field("bd_c3nc4s1s", "cinco_base_de_personal", "datos", "talla_pantalon", capabilities={"supports_filter": True}, definition="Talla de pantalon del empleado. [json_path=$.tallas.pantalon][semantic_type=uniform_size][missing_value_alert=incomplete_information][multiple_semantic_views_allowed=true][privacy=low]"),
        ...
        if domain_code == "empleados":
            base.extend(
                [
                    ...
                    ("tipo_labor", "operativo"),
                    ("tipo_labor", "administrativo"),
                    ("tipo_labor", "supervisor"),
                    ("tipo_labor", "transversal"),
